...
def rabbits(num_months, rabbit_pairs):
   "function for modeling the total number of rabbit pairs"
   fertile_adults = 0 #adults who can procreate
   new_adults = 0 #adults who can't procreate
   baby_rabbits = 1 #
   month = 1
   while month < num_months:
    new_adults = fertile_adults + baby_rabbits 
    baby_rabbits = fertile_adults * rabbit_pairs
